...
public class GenerateLinkUtils {
	...
	private static final String CHECK_CODE = "codeUrl";

	public static String generateActivateLink(User user) {
		return "http://localhost:8080/projectManager/user/activate?userID=" + user.getUserID() + "&" + CHECK_CODE + "="
